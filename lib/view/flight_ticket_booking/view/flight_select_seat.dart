...
class FlightSelectSeatPage extends StatefulWidget {
  const FlightSelectSeatPage({super.key});

  @override
  State<FlightSelectSeatPage> createState() => _FlightSelectSeatPageState();
}

class _FlightSelectSeatPageState extends State<FlightSelectSeatPage> {
  @override
          ...
          builder: (flightTicketController) {
            return Column(
              children: [
                ...
                CommonMethods.sizedBox(height: 13.h),
                Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      CommonMethods.sizedBox(height: 21.h),
                      GestureDetector(
                        onTap: flightTicketController.isNavigationBookingDetail
                            ? () {
                                CommonMethods.jumpOutFromScreen(context);
                                flightTicketController.setNavigation(false);
                              }
                            : () {
                                CommonMethods.sendToNextScreen(
                                    context, RoutesPath.flightPaymentDetail);
                              },
